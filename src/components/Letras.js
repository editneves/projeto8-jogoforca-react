...
export default function Letras({ setStyle, fimJogo, setFimJogo, count, setPalavraCor, setImagem, palavraCor, setDisable, setCount, disable, palpites, style, palavraEscolhida, setPalpites, letraPalavraEscolhida, setStylePalavra }) {
    ...
    const handleClick = (letra) => {
        ...
        if (palavraEscolhida.includes(letra)) {
            ...
            for (let i = 0; i < letraPalavraEscolhida.length; i++) {
                ...
                console.log("letra do chute", chute)
